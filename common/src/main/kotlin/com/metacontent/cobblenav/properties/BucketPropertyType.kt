...
object BucketPropertyType : CustomPokemonPropertyType<StringProperty> {
    const val BASE_KEY = "cobblenavbucket"

    override val keys = setOf(BASE_KEY, "bucket")
    override val needsKey = true

    override fun fromString(value: String?) = value?.let { bucket ->
        StringProperty(
            key = BASE_KEY,
            value = bucket,
